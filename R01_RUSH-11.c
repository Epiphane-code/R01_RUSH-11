...
void calculatrice() {
    ...
    printf("Entrez votre operation (Exp: 3 + 8) : ");
    scanf("%lf %c %lf" , &num1, &operateur, &num2);
    switch (operateur) {
        case '+':
       ...
       case 1:
             {
                ...
                while (retour==0)
                {
                    ...
                    printf("\nTaper 1 pour continuer et 0 pour retourner au menu principal: ");
                    scanf("%d", &test);
                    if (test!=1) retour=1;
             ...
             int test, retour=0;
                while (retour==0)
                {
                    ...
                    printf("\nEntrez le nombre \nReponse: ");
                     scanf("%d",&n);
                     int k=(si_premier(n));
                    if (k==1) printf("Le nombre %d est premier\n", n);
        ...
        case 10: {
             ...
             int test, retour=0;
                while (retour==0)
                {
                    ...
                    printf("\nEntrez le nombre :");
                    scanf("%d",&n);
                    printf("Le factorielle de %d est : %llu ", n, factorielle(n));
